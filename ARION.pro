...
isEmpty(BDB_LIB_PATH) {
    macx:BDB_LIB_PATH = /usr/local/opt/db4.8.30.NC/lib
...
isEmpty(BDB_INCLUDE_PATH) {
    macx:BDB_INCLUDE_PATH = /usr/local/opt/db4.8.30.NC/include
...
macx:ICON = src/qt/res/icons/arion.icns
macx:TARGET = "Arion-Qt"
