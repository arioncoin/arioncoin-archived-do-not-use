...
public:
    ...
    std::string BudgetAddress() const { return strBudgetAddress; }
    int BudgetPercentage() const { return fBudgetPercentage; }
protected:
    CChainParams() {};
    ...
    std::string strBudgetAddress;
    int fBudgetPercentage;
};
