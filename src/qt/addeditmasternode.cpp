...
void AddEditMasterNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (123.45.67.89:45130)");
        msg.exec();
        return;
    }
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter the transaction hash for the transaction that has 5,000 coins");
        msg.exec();
        return;
    }
